...
class BaseObject:
    def __init__(self, health=1000, position=[0,0], velocity=[0,0], acceleration=[0,0], size=100, control=None):
        self.health = health
...
class Wall(BaseObject):
    def __init__(self, health=1000, position=[0, 0], velocity=[0,0], acceleration=[0,0], size=[100, 100], control=None,
                 small_size=0.5, width=2, color_left=[70, 150, 250, 0], color_down=[0, 0, 0, 0], color_right=[0, 0, 0, 0],
                 color_up=[70, 150, 250, 0], color_center=[0, 80, 150, 0]):
        super().__init__(health, position, velocity, acceleration, size=size, control=control)
...
class Life(BaseObject):
    def __init__(self, health=1000, position=[0, 0], velocity=[0, 0], acceleration=[0, 0], size=44, control=None,
                 small_size=0.84, spin=0, spin_velocity=0, spin_acceleration=0,
